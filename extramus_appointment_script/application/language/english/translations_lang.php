...
$lang['service_and_provider'] = 'Appointment Booking';
$lang['select_service'] = 'Select Department';
...
$lang['customer_information'] = 'Intern Information';
$lang['first_name'] = 'First Name';
$lang['last_name'] = 'Last Name';
$lang['email'] = 'Email';
$lang['phone_number'] = 'WhatsApp Number';
$lang['phone'] = 'Phone';
$lang['address'] = 'Place of study';
$lang['city'] = 'Nationality';
$lang['zip_code'] = 'CV';
$lang['gender'] = 'Gender';
$lang['months'] = 'Preferred period';
$lang['notes'] = 'Comments';
...
$lang['customer_details_title'] = 'Intern Details';
$lang['service'] = 'Department';
$lang['provider'] = 'Interviewer';
$lang['customer'] = 'Intern';
$lang['start'] = 'Start';
$lang['end'] = 'End';
$lang['name'] = 'Name';
$lang['appointment_link_title'] = 'Manage Appointment (View/Cancel)';
...
$lang['manage_appointment_record_hint'] = 'Manage all the appointment records of the available Interviewers and Departments.';
$lang['select_filter_item_hint'] = 'Select an Interviewer or a Department and view the appointments on the calendar.';
$lang['enable_appointment_sync_hint'] = 'Enable appointment synchronization with Interviewer\'s Google Calendar account.';
$lang['manage_customers_hint'] = 'Manage the registered Interns and view their booking history.';
$lang['manage_services_hint'] = 'Manage the available Departments and categories of the system.';
$lang['manage_users_hint'] = 'Manage the backend users (admins, Interviewers, HR Staff).';
...
$lang['select'] = 'Select';
$lang['hide'] = 'Hide';
$lang['type_to_filter_customers'] = 'Type to filter Interns.';
$lang['clear_fields_add_existing_customer_hint'] = 'Clear the fields and enter a new Intern.';
$lang['pick_existing_customer_hint'] = 'Pick an existing Intern.';
...
$lang['customers'] = 'Interns';
$lang['details'] = 'Details';
$lang['no_records_found'] = 'No records found...';
$lang['services'] = 'Departments';
...
$lang['secretary_saved'] = 'HR Staff saved successfully.';
$lang['admin_deleted'] = 'Admin deleted successfully.';
$lang['provider_deleted'] = 'Interviewer deleted successfully.';
$lang['secretary_deleted'] = 'HR Staff deleted successfully.';
$lang['service_saved'] = 'Department saved successfully.';
$lang['service_category_saved'] = 'Department category saved successfully.';
$lang['service_deleted'] = 'Department deleted successfully.';
$lang['service_category_deleted'] = 'Department category deleted successfully.';
$lang['customer_saved'] = 'Intern saved successfully.';
$lang['customer_deleted'] = 'Intern deleted successfully.';
...
$lang['go_to_booking_page'] = 'Book New Appointment';
$lang['settings_saved'] = 'Settings saved successfully.';
$lang['general'] = 'General';
$lang['business_logic'] = 'Business Logic';
$lang['current_user'] = 'Current User';
$lang['about_app'] = 'About Extramus Appointment';
$lang['edit_working_plan_hint'] = 'Mark below the days and hours that your company will accept appointments. You will be able to adjust appointments in non-working hours but the Interns will not be able to book appointments by themselves in non-working periods. This working plan will be the default for every new Interviewer record, but you will be able to change each Interviewer\'s plan separately by editing his record. After that you can add break periods.';
...
$lang['book_advance_timeout_hint'] = 'Define the timeout (in minutes) before the Interns can book or re-arrange appointments with the company.';
$lang['timeout_minutes'] = 'Timeout (Minutes)';
$lang['about_app_info'] = 'Extramus Appointment is a highly customizable web application that allows your Interns to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using Extramus Appointment you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'Extramus Appointment is licensed under the GPLv3 license. By using the code of Extramus Appointment in any way you are agreeing to the terms described in the following url:';
...
$lang['backend_section'] = 'Dashboard';
$lang['you_need_to_login'] = 'Welcome! You will need to login in order to proceed.';
...
$lang['delete_customer'] = 'Delete Intern';
$lang['delete_service'] = 'Delete Department';
$lang['delete_category'] = 'Delete Department Category';
$lang['delete_provider'] = 'Delete Interviewer';
$lang['delete_secretary'] = 'Delete HR Staff';
...
$lang['ea_update_success'] = 'Extramus Appointment has been successfully updated.';
$lang['require_captcha'] = 'Require CAPTCHA';
$lang['require_captcha_hint'] = 'When enabled, the Interns will have to type a random generated CAPTCHA string before booking/updating an appointment.';
...
$lang['customer_notifications'] = 'Intern Notifications';
$lang['customer_notifications_hint'] = 'Defines whether the Intern will receive email notifications whenever there is a schedule change on one of his appointments.';
...
$lang['read_and_agree_to_terms_and_conditions'] = 'I have read and agree to these {$link}Terms & Conditions{/$link}.';
...
$lang['require_phone_number_hint'] = 'When enabled, Interns and users will need to enter the Intern\'s phone number when booking an appointment';
$lang['check_spam_folder'] = 'Please check your spam folder if the email does not arrive within a few minutes.';
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the Extramus Appointment API.';
...
$lang['display_any_provider_hint'] = 'The booking page will get an additional option that allows Interns to book without specifying an Interviewer.';
