...
<div class="email-container" style="width: 650px; border: 1px solid #eee;">
    ...
    <div id="content" style="padding: 10px 15px;">
        ...
        <table id="customer-details">
            ...
            <tr>
                <td class="label" style="padding: 3px;font-weight: bold;">Gender</td>
                <td style="padding: 3px;"><?= $customer_gender ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label" style="padding: 3px;font-weight: bold;">Preferred Months of Internship</td>
                <td style="padding: 3px;"><?= $customer_months ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding: 3px;"><?= $customer_cv ?></td>
            </tr>
            <tr>
