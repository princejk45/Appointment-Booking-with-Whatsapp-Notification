        ...
        <div class="record-details col-12 col-md-7">
            <div class="btn-toolbar mb-4">
                <div id="add-edit-delete-group" class="btn-group">
                    ...
                    <?php endif ?>
                    <button id="export_btn" class="btn btn-outline-secondary">
                            <i class="fas fa-download"></i>
                           Export all Interns to CSV
                        </button>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $("#export_btn").click(function() {
                // Perform AJAX request to trigger the export
                $.ajax({
                    url: 'https://extramus.naijanetsolution.com/en/export.php',
                    method: 'POST',
                    data: { export: true },
                    xhrFields: {
